...
if __name__ == "__main__":
    ...
    argparser.add_argument("--input_file", type=str, default="outputs/team_name_questions_filtered.json", help="Path to the input JSON file with questions")
    argparser.add_argument("--output_file", type=str, default="outputs/team_name_answers.json", help="Path to save the answers")
    ...
    for idx, (q, a) in enumerate(zip(sample_questions, answer)):
        ...
        try:
            ...
            if all(k in a for k in ['answer', 'reasoning']):
                ...
                a = agent.agent.generate_response(prompt.format(json.dumps(a, indent=4))) # HACK: <------------------------------------
